    ...
    var n = function (e, t) {
        ...
        y = {
            ...
            line: function (e, t, i, r) {
                ...
                if (
                    (l(a, { x1: f.x, y1: f.y, x2: p.x, y2: p.y }),
                    t.lineDecoration)
                ) {
            ...
            var a = r.x > 0.5 ? 1 - r.x : r.x,
                ...
                s = (function (e, t) {
                    var i = e.width,
                        ...
                        c = M(
                            e.x + e.width + Math.abs(n.y),
                            e.y + Math.abs(n.x)
                        ),
                        s = M(
                            e.x - Math.abs(n.y),
                            e.y + e.height - Math.abs(n.x)
                        );
            ...
            var t = e.utils.createView({
                ...
                a = function (e, t, i) {
                    return new Promise(function (a) {
                        ...
                        if (!t || 20 !== t.length)
                            return (
                                i.getContext("2d").putImageData(n, 0, 0), a()
                            );
                        var o = r(O);
                        o.post(
            ...
            return e.utils.createView({
                ...
                write: e.utils.createRoute(
                    ...
                    function (e) {
                        ...
                        (t.ref.imageViewBin = t.ref.imageViewBin.filter(
                            function (e) {
                                return e.opacity > 0;
                            }
                        )),
                            ...
                            a(
                                {
                                    ...
                                    DID_IMAGE_PREVIEW_CALCULATE_SIZE: function (
                                        e
                                    ) {
                                        var t = e.root,
                                            i = e.action;
