...
<head>
    ...
    <title>{{ config('app.name', 'Anant TVS') }}</title>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <main>
                ...
                <div class="container-fluid card" style="position: fixed; top: 92%;">
                    <div class="row justify-content-center d-flex">
                        <div class="col-xl-4 col-4">
                            <div class="card-height-20">
                                <div class="">
                                    <div class="flex-grow-1 p-3 mt-3">
                                        <a href="#"><h5 class="mb-3"><i class="bi bi-house"></i>&nbsp;Home</h5></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-4">
                            <div class="card-height-20">
                                <div class="">
                                    <div class="flex-grow-1 p-3 mt-3">
                                        <a href="#"><h5 class="mb-3"><i class="bi bi-car-front"></i>&nbsp;Vehicles</h5></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-4">
                            <div class="card-height-20">
                                <div class="">
                                    <div class="flex-grow-1 p-3 mt-3">
                                        <a href="#"><h5 class="mb-3"><i class="bi bi-credit-card"></i>&nbsp;Payment</h5></a>
                                    </div>
                                </div>
                            </div>
                        </div>
