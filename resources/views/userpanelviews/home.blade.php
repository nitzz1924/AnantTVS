                                                ...
                                                <div class="row justify-content-md-center">
                                                    <div class="col-xxl-3 col-6">
                                                        <div class="text-center mt-2">
                                                            ...
                                                            <a href="{{ route('alluservehiclesview') }}"
                                                                class="btn btn-dark waves-effect waves-light mt-2"><i
                                                    ...
                                                    <div class="col-xxl-3 col-6">
                                                        <div class="text-center mt-2">
                                                            ...
                                                            <a href="#"
                                                                class="btn btn-info waves-effect waves-light mt-2"><i
                                                    ...
                                                    <div class="col-xxl-3 col-6">
                                                        <div class="text-center mt-2">
                                                            ...
                                                            <a href="{{ route('allvehicleslist') }}"
                                                                class="btn btn-secondary waves-effect waves-light mt-2"><i
